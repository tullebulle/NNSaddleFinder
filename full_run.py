...
from function_wrapper import nequip_potential, grad_potential
...
saddle_finder = NNSaddleFinder(nequip_potential, initial_positions, step_size=0.01, momentum=0.8, saddle_index=4, grad_fn=grad_potential)
...
plt.ylabel(r"$\| \nabla f \|$")
plt.savefig("grad_norm_history.png")
plt.show()
